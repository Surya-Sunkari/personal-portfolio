        ...
        <div className='mx-auto flex flex-col items-center justify-center h-full px-4 md:flex-col'>
          <div className='w-full grid grid-cols-1 sm:grid-cols-2 gap-8 text-center py-8 px-12'>
            <div className='flex flex-col items-center justify-center'>
              <motion.div variants={fadeIn('up', 0.3)} initial="hidden" whileInView={'show'} viewport={{once: false, amount: 0.7}} className={'text-4xl sm:text-6xl font-bold text-white ' + (nav && 'hidden')}>
                <span>I am </span>
              ...
              <motion.p variants={fadeIn('up', 0.3)} initial="hidden" whileInView={'show'} viewport={{once: false, amount: 0.7}} className='text-gray-500 py-4 max-w-md'>
