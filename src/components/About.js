        ...
        <div className='text-center w-full h-screen bg-black text-white md:h-screen mb-96 md:mb-76'>
            <div name="about" className='w-full h-full bg-black text-white pt-24 md:pt-20'>
                <div className='max-w-screen-lg p-4 mx-auto my-auto flex flex-col justify-center items-center pb-10'>
                    <motion.div variants={fadeIn('down', 0.3)} initial="hidden" whileInView={'show'} viewport={{once: true, amount: 0.7}}>
                        <p className='text-4xl font-bold inline p-2 pt-3 rounded-xl bg-white text-black'>About</p>
                    </motion.div>
                    <motion.p variants={fadeIn('up', 0.3)} initial="hidden" whileInView={'show'} viewport={{once: true, amount: 0.7}} className='text-xl mt-8 text-center'>
                    ...
                    <br />
                    <motion.p variants={fadeIn('up', 0.3)} initial="hidden" whileInView={'show'} viewport={{once: true, amount: 0.7}} className='text-xl text-center'>
                ...
                <motion.div variants={fadeIn('left', 0.3)} initial="hidden" whileInView={'show'} viewport={{once: true, amount: 0.7}} className='max-w-screen-lg mx-auto my-auto pt-10'>
